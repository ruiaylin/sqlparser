...
func (s *testParserSuite) TestSimple(c *C) {
	...
	// Fix: https://github.com/ruiaylin/sqlparser/issues/971
...
func (s *testParserSuite) TestDMLStmt(c *C) {
	...
	table := []testCase{
		...
		// For https://github.com/ruiaylin/sqlparser/issues/320
		{`(select 1);`, true},

		// For https://github.com/ruiaylin/sqlparser/issues/1050
...
func (s *testParserSuite) TestType(c *C) {
	...
	table := []testCase{
		...
		// For https://github.com/ruiaylin/sqlparser/issues/312
